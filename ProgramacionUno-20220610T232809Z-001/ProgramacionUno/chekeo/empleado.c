...
int addEmployee(Employee list[], int len, int id, char name[], char lastName[], float salary, int sector)
{
    ...
    if(list!=NULL && len>0 && name!=NULL && lastName!=NULL)
    {
        ...
        if(availableIndex>=0)
        {
            ...
            checkString(name,
                        "Ingrese el/los nombre(s) del empleado (hasta 20 caracteres): ",
                        "Nombre demasiado largo. Ingrese el/los nombre(s) del empleado (hasta 20 caracteres): ",
                        20);
            strcpy(list[availableIndex].name, name);

            checkString(lastName,
                        "Ingrese el/los apellido(s) del empleado (hasta 20 caracteres): ",
                        "Apellido demasiado largo. Ingrese el/los apellido(s) del empleado (hasta 20 caracteres): ",
                        20);
