...
int main()
{
    ...
    do
    {
        switch(funcionMenu(a, b, ingresoPrimerOperador, ingresoSegundoOperador))
        {
            case 1:
                if(ingresoPrimerOperador==1)
                {
                    printf("Ya ingreso como primer operador el numero: %.1f\n",a);
                }
                else
                {
            ...
            case 2:
                ...
                else
                {
                    ...
                    {
                        printf("Ya ingreso como segundo operador el numero: %.1f\n", b);
                    }
                    else
                    {
            ...
            case 3:
                if(ingresoSegundoOperador==1)
                {
                    if(realizarOperaciones(a, b, &suma, &resta, &division, &factorialDeA, &factorialDeB, &multiplicacion, &sePudoDividir, &seHizoFactorialDeA, &seHizoFactorialDeB)==0)
                    {
