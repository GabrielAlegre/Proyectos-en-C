...
int main()
{
    eEmpleado* unEmpleadoDinamico = NULL;

    unEmpleadoDinamico = new_EmpleadoParam(4, "Julia", "Argenta", 'j', 120000);
    if(unEmpleadoDinamico==NULL)
    {
        printf("Hubo problema al crear un empleado\n");
        exit(1);
    }

    mostrarUnEmpleado(unEmpleadoDinamico);
