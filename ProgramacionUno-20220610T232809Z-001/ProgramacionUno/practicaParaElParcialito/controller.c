...
int controller_cargarArchivo(LinkedList* pArrayListaPaises, int banderaPaisesExitosos, int banderaPaisesEnElHorno)
{
	...
	if(pArrayListaPaises!=NULL)
	{
	    ...
	    if(banderaPaisesEnElHorno==0 && banderaPaisesExitosos==0)
        {
            printf("\nIngrese el nombre del archivo a leer\nSugerencia: \n-paises.csv\nIngrese nombre: ");
            fflush(stdin);
            gets(nombreDelArchivo);
        }
        else if (banderaPaisesEnElHorno==1 && banderaPaisesExitosos==1)
        {
            printf("\nIngrese el nombre del archivo a leer\nSugerencia: \n-paises.csv\n-paisesEnElHorno.csv\n-paisesExitosos.csv\n\nIngrese nombre: ");
            fflush(stdin);
            gets(nombreDelArchivo);
        }
        else if(banderaPaisesExitosos==1)
        {
            printf("\nIngrese el nombre del archivo a leer\nSugerencia: \n-paises.csv\n-paisesExitosos.csv\n\nIngrese nombre: ");
            fflush(stdin);
            gets(nombreDelArchivo);
        }
        else if(banderaPaisesEnElHorno==1)
        {
            printf("\nIngrese el nombre del archivo a leer\nSugerencia: \n-paises.csv\n-paisesEnElHorno.csv\n\nIngrese nombre: ");
            fflush(stdin);
            gets(nombreDelArchivo);
...
int controller_sortPaises(LinkedList* pArrayListaPaises)
{
	int todoOk=0;
	int order;
    ...
    if(pArrayListaPaises!=NULL)
    {
        ...
        if(listaFiltradaPaisesExitosos != NULL)
        {
            ...
            if(tamLista>0)
            {
                ...
                controller_guardarListaTexto("paisesExitosos.csv", listaFiltradaPaisesExitosos);
