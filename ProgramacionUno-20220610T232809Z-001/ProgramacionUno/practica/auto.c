...
int altaAuto(eAuto arrayAutos[], int tamAuto, eMarca marcas[], int tamMarca, eColor colores[], int tamColor, eCliente clientes[], int tamClientes, int* pIdAuto)
{
    ...
    if(arrayAutos!=NULL && tamAuto>0 && marcas!=NULL && tamMarca>0 && colores!=NULL && tamColor>0 && clientes!=NULL && tamClientes>0 && pIdAuto!=NULL)
    {
        system("cls");
        ...
        else
        {
            ...
            while(buscarClientePorId(clientes, tamClientes, auxAuto.idCliente)<0)
            {
                printf("Id invalido, reingrese el id del cliente: ");
                fflush(stdin);
                scanf("%d", &auxAuto.idCliente);
            }
            ...
            printf("Id\tMarca           Color      Caja    Nombre del cliente\n");
            mostrarUnAuto(arrayAutos[indiceLibre], marcas, tamMarca, colores, tamColor, clientes, tamClientes);
        }
        todoOk=1;
    }
    return todoOk;
...
int mostrarUnAuto(eAuto unAuto, eMarca marcas[], int tamMarca, eColor colores[], int tamColor, eCliente clientes[], int tamClientes)
{
    ...
    if(marcas!=NULL && tamMarca>0 && colores!=NULL && tamColor>0 && clientes!=NULL && tamClientes>0)
    {
        cargarDescripcionColor(colores, tamColor, unAuto.idColor, descripcionColor);
        cargarNombreCliente(clientes, tamClientes, unAuto.idCliente, nombreDelCliente);
        cargarDescripcionMarca(marcas, tamMarca, unAuto.idMarca, descripcionMarca);

        printf("%d\t%-15s %-10s %-5c   %-15s\n",
           unAuto.id,
           descripcionMarca,
           descripcionColor,
           unAuto.caja,
...
{
    int todoOk=1;
    if(arrayAutos!=NULL && tamAuto>0 && marcas!=NULL && tamMarca>0 && colores!=NULL && tamColor>0 && clientes!=NULL && tamClientes>0)
    {
        system("cls");
        printf("--------------------------------------------------------------------------------------\n");
        ...
        for(int i=0; i<tamAuto; i++)
        {
            ...
            {
                mostrarUnAuto(arrayAutos[i], marcas, tamMarca, colores, tamColor, clientes, tamClientes);
            }
        }
        todoOk=1;
    }
...
int bajaAuto(eAuto arrayAutos[], int tamAuto, eMarca marcas[], int tamMarca, eColor colores[], int tamColor, eCliente clientes[], int tamClientes)
{
    ...
    if(arrayAutos!=NULL && tamAuto>0 && marcas!=NULL && tamMarca>0 && colores!=NULL && tamColor>0 && clientes!=NULL && tamClientes>0)
    {
        ...
        printf("\n");
        mostrarAutos(arrayAutos, tamAuto, marcas, tamMarca, colores, tamColor, clientes, tamClientes);
        printf("\n--------------------------------------------------------------------------------------\n");
        ...
        {
            printf("Id\tMarca           Color      Caja    Nombre del cliente\n");
            mostrarUnAuto(arrayAutos[indiceAutoBajar], marcas, tamMarca, colores, tamColor, clientes, tamClientes);
...
int modificarAuto(eAuto arrayAutos[], int tamAuto, eMarca marcas[], int tamMarca, eColor colores[], int tamColor, eCliente clientes[], int tamClientes)
{
    ...
    if(arrayAutos!=NULL && tamAuto>0 && marcas!=NULL && tamMarca>0 && colores!=NULL && tamColor>0 && clientes!=NULL && tamClientes>0)
    {
        ...
        if(indiceModificarAuto>=0)
        {
            ...
            mostrarUnAuto(arrayAutos[indiceModificarAuto], marcas, tamMarca, colores, tamColor, clientes, tamClientes);
...
int informeAutoMasViejo(eAuto arrayAutos[], int tamAuto, eMarca marcas[], int tamMarca, eColor colores[], int tamColor, eCliente clientes[], int tamClientes)
{
	...
	if(arrayAutos!=NULL && tamAuto>0 && marcas && tamMarca && colores!=NULL && tamColor>0)
	{
		...
		mostrarUnAuto(arrayAutos[indiceDelAutoMasViejo], marcas, tamMarca, colores, tamColor, clientes, tamClientes);
...
int informeAutosPorMarcas(eAuto arrayAutos[], int tamAuto, eMarca marcas[], int tamMarca, eColor colores[], int tamColor, eCliente clientes[], int tamClientes)
{
	...
	if(arrayAutos!=NULL && tamAuto>0 && marcas && tamMarca && colores!=NULL && tamColor>0)
	{
        ...
        for(int i=0; i<tamMarca; i++)
        {
            ...
            mostrarAutosPorIdMarca(arrayAutos, tamAuto, marcas, tamMarca, colores, tamColor, clientes, tamClientes, marcas[i].id);
        }
        todoOk=1;
	}
	return todoOk;
...
int informeSoloDeAutos(eAuto arrayAutos[], int tamAuto, eMarca marcas[], int tamMarca, eColor colores[], int tamColor, eCliente clientes[], int tamClientes)
{
    ...
    system("cls");
        ...
        {
            case 1:
                informeMostrarAutosDeUnColor(arrayAutos, tamAuto, marcas, tamMarca, colores, tamColor, clientes, tamClientes);
                break;

            case 2:
                informeMostrarAutosDeUnaMarca(arrayAutos, tamAuto, marcas, tamMarca, colores, tamColor, clientes, tamClientes);
                break;

            case 3:
                 informeAutoMasViejo(arrayAutos, tamAuto, marcas, tamMarca, colores, tamColor, clientes, tamClientes);
                break;

            case 4:
                informeAutosPorMarcas(arrayAutos, tamAuto, marcas, tamMarca, colores, tamColor, clientes, tamClientes);
                break;

            case 5:
                informeCantAutosDeUnColorMarca(arrayAutos, tamAuto, marcas, tamMarca, colores, tamColor, clientes, tamClientes);
                break;

            case 6:
                informeMarcaDeAutoMasElegida(arrayAutos, tamAuto, marcas, tamMarca, colores, tamColor, clientes, tamClientes);
                break;
