...
int altaDeTrabajo(eTrabajo arrayDeTrabajos[], int tamTrab, eAuto autos[], int tamAuto, eServicio servicios[], int tamServ, eMarca marcas[], int tamMarca, eColor colores[], int tamColores, eCliente clientes[], int tamClientes, int* pIdTrabajo)
{
    ...
    if(arrayDeTrabajos!=NULL && tamTrab>0 && autos!=NULL && tamAuto>0 && servicios!=NULL && tamServ>0 && pIdTrabajo!=NULL && marcas!=NULL && tamMarca>0 && colores!=NULL && tamColores>0 && clientes!=NULL && tamClientes>0)
    {
        system("cls");
        ...
        {
            mostrarAutos(autos, tamAuto, marcas, tamMarca, colores, tamColores, clientes, tamClientes);
...
int trabajosDeUnAuto(eTrabajo arrayTrabajos[], int tamTrab,  eAuto autos[], int tamAuto, eServicio servicios[], int tamServ, eMarca marcas[], int tamMarca, eColor colores[], int tamColores, eCliente clientes[], int tamClientes)
{
    ...
    if(arrayTrabajos!=NULL && tamTrab>0 && autos!=NULL && tamAuto>0 && servicios!=NULL && tamServ>0 && marcas!=NULL && tamMarca>0 && colores!=NULL && tamColores>0 && clientes!=NULL && tamClientes>0)
    {
        system("cls");
        mostrarAutos(autos, tamAuto, marcas, tamMarca, colores, tamColores, clientes, tamClientes);
        printf("\n--------------------------------------------------------------------------------------------------------------\n");
        ...
        printf("\nLos trabajos que se le realizaron al auto elegido son: \n");
        printf("ID TRABAJO|           AUTOS                | SERVICIO   PRECIO SERVICIO   FECHA SERVICIO \n");
        printf("          | Id   Marca       Color    Caja |                                               \n");
...
int autosDeUnServicio(eTrabajo arrayTrabajos[], int tamTrab,  eAuto autos[], int tamAuto, eServicio servicios[], int tamServ, eMarca marcas[], int tamMarca, eColor colores[], int tamColores, eCliente clientes[], int tamCliente)
{
    ...
    if(arrayTrabajos!=NULL && tamTrab>0 && autos!=NULL && tamAuto>0 && servicios!=NULL && tamServ>0 && marcas!=NULL && tamMarca>0 && colores!=NULL && tamColores>0 && clientes!=NULL && tamCliente>0)
    {
        ...
        printf("  Fecha     Id  Marca           Color      Caja    Nombre del cliente\n");
        ...
        for(int i=0;i<tamTrab;i++)
        {
            ...
            if(arrayTrabajos[i].isEmpty==0 && indiceAuto>=0)
            {
                if(arrayTrabajos[i].idServicio==idDelServicio)
                {
                    ...
                    mostrarUnAuto(autos[idDelAutoConElServicioElegido], marcas, tamMarca, colores, tamColores, clientes, tamCliente);
                    noHuboServicio=0;
...
int informesAutosTrabajos(eTrabajo arrayTrabajos[], int tamTrab,  eAuto autos[], int tamAuto, eServicio servicios[], int tamServ, eMarca marcas[], int tamMarca, eColor colores[], int tamColores, eCliente clientes[], int tamClientes)
{
    ...
    if(arrayTrabajos!=NULL && tamTrab>0 && autos!=NULL && tamAuto>0 && servicios!=NULL && tamServ>0 && marcas!=NULL && tamMarca>0 && colores!=NULL && tamColores>0 && clientes!=NULL && tamClientes>0)
    {
        ...
        {
            case 7:
                trabajosDeUnAuto(arrayTrabajos, tamTrab, autos, tamAuto, servicios, tamServ, marcas, tamMarca, colores, tamColores, clientes, tamClientes);
                break;

            case 8:
                importeTotalDeUnAuto(arrayTrabajos, tamTrab, autos, tamAuto, servicios, tamServ, marcas, tamMarca, colores, tamColores, clientes, tamClientes);
                break;

            case 9:
                 autosDeUnServicio(arrayTrabajos, tamTrab, autos, tamAuto, servicios, tamServ, marcas, tamMarca, colores, tamColores, clientes, tamClientes);
                break;
...
int menuInformes(eTrabajo arrayTrabajos[], int tamTrab,  eAuto autos[], int tamAuto, eServicio servicios[], int tamServ, eMarca marcas[], int tamMarca, eColor colores[], int tamColores, eCliente clientes[], int tamClientes)
{
    ...
    scanf("%d", &opcion);
        ...
        {
            case 1:
                 informeSoloDeAutos(autos, tamAuto, marcas, tamMarca, colores, tamColores, clientes, tamClientes);
                break;

            case 2:
                informesAutosTrabajos(arrayTrabajos, tamTrab, autos, tamAuto, servicios, tamServ, marcas, tamMarca, colores, tamColores, clientes, tamClientes);
                break;
