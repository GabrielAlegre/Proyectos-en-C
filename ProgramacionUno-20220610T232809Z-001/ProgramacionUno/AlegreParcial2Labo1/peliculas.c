...
int filtroPeliculasAnimation(void* pElement)
{
    int retorno=0;
    char generoAnimation[30];
    ...
    {
        auxPeli = (eMovie*) pElement;
        peliGetGenero(auxPeli, generoAnimation);

        if(!strcmp(generoAnimation, "Animation"))
        {
            retorno=1;
        }
    }
...
int filtroPeliculasMusical(void* pElement)
{
    int retorno=0;
    ...
    {
        auxPeli = (eMovie*) pElement;
        peliGetGenero(auxPeli, generoMusical);

        if(!strcmp(generoMusical, "Musical"))
        {
            retorno=1;
        }
    }
...
int filtroPeliculasRomance(void* pElement)
{
    int retorno=0;
    char generoRomance[30];
    ...
    {
        auxPeli = (eMovie*) pElement;
        peliGetGenero(auxPeli, generoRomance);

        if(!strcmp(generoRomance, "Romance"))
        {
            retorno=1;
        }
    }
...
int filtroPeliculasThriller(void* pElement)
{
    int retorno=0;
    char generoThriller[30];
    ...
    {
        auxPeli = (eMovie*) pElement;
        peliGetGenero(auxPeli, generoThriller);

        if(!strcmp(generoThriller, "Thriller"))
        {
            retorno=1;
        }
    }
...
int filtroPeliculasWestern(void* pElement)
{
    int retorno=0;
    char generoWestern[30];
    ...
    {
        auxPeli = (eMovie*) pElement;
        peliGetGenero(auxPeli, generoWestern);

        if(!strcmp(generoWestern, "Western"))
        {
            retorno=1;
        }
    }
...
int pelis_compararPelis(void* peliUno, void* peliDos)
{
	...
	if(primerPeli != NULL && segundaPeli != NULL)
	{
		...
		else if(strcmp(auxNombreUno, auxNombreDos) == 0 && duracionUno<duracionDos)
        {
            todoOk = 1;
        }
        ...
        {
            if(strcmp(auxNombreUno, auxNombreDos) == 0 && duracionUno<duracionDos)
            {
                todoOk = -1;
            }
        }
        */
		...
		if((strcmp(auxNombreUno, auxNombreDos)==0 && duracionUno<duracionDos)||(strcmp(auxNombreUno, auxNombreDos)>0))
		{
			todoOk=1;
		}
